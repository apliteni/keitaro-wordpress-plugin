...
class Plugin_Name {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      KEITARO_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - KEITARO_Loader. Orchestrates the hooks of the plugin.
	 * - KEITARO_i18n. Defines internationalization functionality.
	 * - KEITARO_Admin. Defines all hooks for the admin area.
	 * - KEITARO_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the KEITARO_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    KEITARO_Loader    Orchestrates the hooks of the plugin.
	 */
